...
if __name__ == '__main__':
    ...
    camera = Cv2Capture(camera_num=1, res=(640, 480), network_table=FrontCameraTable)
    camera.start()
    #if os.name == 'nt':
    #    camera.set(cv2.CV_CAP_PROP_EXPOSURE, configs['exposure'])
    #else:
    #    os.system("v4l2-ctl -c exposure_absolute={}".format(configs['exposure']))
    print("Exposure set to: {}".format(configs['exposure']))
